...
<center style="z-index: 10;top:200px;">
    <button class="afficheCacheMenu2"  id="button2" style="z-index:3;
    border: none;
    padding: 5px 5px;
    font-size: 16px;
    left:0;
    background-color: #FFA900;color:black;position: fixed;vertical-align: bottom;">></button>
...
/*
    ...
    */
    ...
    <div id="EmplacementDeMaCarte" align=center></div> 
...
<script type="text/javascript">
               ...
               <a  id="retourtop" href="#top" title="Retour vers le haut"><img src="image/img2/fleche.png"></a>
...
**********************************************************************************************-->       
   ...
   <div id="popup_name" class="popup_block">
        ...
        {
                // alert("salut");
            var nb = prompt("Entrez l'efficience MAX souhaité");
